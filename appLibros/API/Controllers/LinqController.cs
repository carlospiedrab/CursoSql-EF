...
namespace API.Controllers
{
    ...
    public class LinqController : ControllerBase
    {
        ...
        [HttpGet("GetLibrosContainsQuery")]
        public async Task<ActionResult<IEnumerable<Libro>>> GetLibrosContainsQuery(string filtro)
        {
            var lista = await (from l in _context.Libros.Include(l => l.Categoria)
        ...
        public async Task<ActionResult<IEnumerable<Libro>>> GetLibrosOrderByMethod()
        {
